object LearningScala1 {;import org.scalaide.worksheet.runtime.library.WorksheetSupport._; def main(args: Array[String])=$execute{;$skip(126); 
  ...
  println(hello);$skip(31); 
  
  val name: String ="Febin";System.out.println("""name  : String = """ + $show(name ));$skip(23); 
  val  testNum:Int=10;System.out.println("""testNum  : Int = """ + $show(testNum ));$skip(178); ;
  ...
  println(helloThere);$skip(38); 
  
  var nameMy: String="My Name is ";System.out.println("""nameMy  : String = """ + $show(nameMy ));$skip(25); 
  nameMy =nameMy+"Febin";$skip(42); 
  
  val moreStuff:String =nameMy+" Shit";System.out.println("""moreStuff  : String = """ + $show(moreStuff ));$skip(21); 
  println(moreStuff);$skip(306); 
  ...
  // printf style:
  println(f"Pi is about $piSinglePrecision%.4f");$skip(55); 
  ...
  val isBest: Boolean = picard == bestCaptain;System.out.println("""isBest  : Boolean = """ + $show(isBest ));$skip(314); 
  ...
  val numPi:Double =3.14159265f;System.out.println("""numPi  : Double = """ + $show(numPi ));$skip(19); 
  val test=numPi*2;System.out.println("""test  : Double = """ + $show(test ));$skip(33); 
  println(f"Pi value $test%.3f")}
