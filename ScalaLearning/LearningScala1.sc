object LearningScala1 {
  ...
  val name: String ="Febin"                       //> name  : String = Febin
  val  testNum:Int=10;                            //> testNum  : Int = 10
  ...
  var nameMy: String="My Name is "                //> nameMy  : String = "My Name is "
  nameMy =nameMy+"Febin"
  
  val moreStuff:String =nameMy+" Shit"            //> moreStuff  : String = My Name is Febin Shit
  println(moreStuff)                              //> My Name is Febin Shit
  ...
  val numPi:Double =3.14159265f                   //> numPi  : Double = 3.1415927410125732
  val test=numPi*2                                //> test  : Double = 6.2831854820251465
  println(f"Pi value $test%.3f")                  //> Pi value 6.283
